...
<template>
  <div class="relative">
    ...
    >
      ...
      <v-card-title>
        <div
          v-if="card.labels && card.labels.length >= 1"
          class="flex gap-2 items-center flex-wrap"
        >
          <div
            v-for="label in card.labels"
            class="h-2 w-10 rounded"
      ...
      <v-card-text :key="card">
        <div class="flex items-center gap-2">
          ...
          <div class="inline-flex items-center gap-1" v-if="card.checklist">
            ...
            <p>
              {{ card.checklist.checkedItemsCount }} /
              {{ card.checklist.checklistItems?.length || 0 }}
            </p>
          </div>
        </div>
        <div class="flex justify-between items-center">
          <div
            ...
            class="flex pt-3 p-1 -space-x-2 overflow-hidden"
          >
            <UserAvatar
